...
public class MyRoundRectView extends View {
    ...
    public MyRoundRectView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap roundRectImage = createRoundRectImage(dstbmp, new RectF(0, 0, dstbmp.getWidth(), dstbmp.getHeight()));
    ...
    private Bitmap createRoundRectImage(Bitmap source, RectF min)
    {
        final Paint paint = new Paint();
        paint.setAntiAlias(true);
        Bitmap target = Bitmap.createBitmap((int)min.width(), (int)min.height(), Config.ARGB_8888);
        /**
         * 产生一个同样大小的画布
         */
         ...
         * 首先绘制圆形
         */
        canvas.drawRoundRect(min, 20, 20, paint);
        /**
         * 使用SRC_IN
         */
